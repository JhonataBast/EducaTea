...
import 'testeobj1_model.dart';
export 'testeobj1_model.dart';

class Testeobj1Widget extends StatefulWidget {
  const Testeobj1Widget({super.key});

  @override
  State<Testeobj1Widget> createState() => _Testeobj1WidgetState();
}

class _Testeobj1WidgetState extends State<Testeobj1Widget> {
  late Testeobj1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Testeobj1Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'testeobj1'});
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'TESTEOBJ1_keyboard_backspace_sharp_ICN_O');
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'TESTEOBJ1_PAGE_menu_rounded_ICN_ON_TAP');
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'TESTEOBJ1_PAGE_Row_3vetbeq1_ON_TAP');
                                // errou
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'TESTEOBJ1_PAGE_Row_9v3u8qxb_ON_TAP');
                                  // errou
