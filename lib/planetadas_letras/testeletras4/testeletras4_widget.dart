...
import 'testeletras4_model.dart';
export 'testeletras4_model.dart';

class Testeletras4Widget extends StatefulWidget {
  const Testeletras4Widget({super.key});

  @override
  State<Testeletras4Widget> createState() => _Testeletras4WidgetState();
}

class _Testeletras4WidgetState extends State<Testeletras4Widget> {
  late Testeletras4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Testeletras4Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'testeletras4'});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'TESTELETRAS4_keyboard_backspace_sharp_IC');
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'TESTELETRAS4_menu_rounded_ICN_ON_TAP');
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS4_Container_gxvc17zn_ON_TAP');
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS4_Container_wm4lwfa5_ON_TAP');
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS4_Container_f8ocldrk_ON_TAP');
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS4_Container_tuyilcal_ON_TAP');
