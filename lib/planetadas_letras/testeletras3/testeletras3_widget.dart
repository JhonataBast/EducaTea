...
import 'testeletras3_model.dart';
export 'testeletras3_model.dart';

class Testeletras3Widget extends StatefulWidget {
  const Testeletras3Widget({super.key});

  @override
  State<Testeletras3Widget> createState() => _Testeletras3WidgetState();
}

class _Testeletras3WidgetState extends State<Testeletras3Widget> {
  late Testeletras3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Testeletras3Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'testeletras3'});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'TESTELETRAS3_keyboard_backspace_sharp_IC');
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'TESTELETRAS3_menu_rounded_ICN_ON_TAP');
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS3_Container_ewb7xged_ON_TAP');
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS3_Container_ct6z0t2r_ON_TAP');
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS3_Container_j7e3yvzf_ON_TAP');
                                        await showModalBottomSheet(
                                          isScrollControlled: true,
                                          backgroundColor: Colors.transparent,
                                          enableDrag: false,
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TESTELETRAS3_Container_qgfzhsju_ON_TAP');
