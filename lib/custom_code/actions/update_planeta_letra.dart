...
Future<void> updatePlanetaLetra(String alunoId, int planetaLetra,
  ...
  try {
    ...
    if (alunoDoc.exists) {
      await db.doc(alunoId).update({
        'respostaCertaLetra': planetaLetra,
        'respostaErradaLetra': 5 - planetaLetra,
        'tempoGastoLetra': tempoTotalFormatado,
      });
