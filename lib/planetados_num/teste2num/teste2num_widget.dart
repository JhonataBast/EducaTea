...
import 'teste2num_model.dart';
export 'teste2num_model.dart';

class Teste2numWidget extends StatefulWidget {
  const Teste2numWidget({super.key});

  @override
  State<Teste2numWidget> createState() => _Teste2numWidgetState();
}

class _Teste2numWidgetState extends State<Teste2numWidget> {
  late Teste2numModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Teste2numModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'teste2num'});
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'TESTE2NUM_keyboard_backspace_sharp_ICN_O');
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TESTE2NUM_PAGE_menu_rounded_ICN_ON_TAP');
