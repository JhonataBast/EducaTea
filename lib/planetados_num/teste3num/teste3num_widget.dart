...
import 'teste3num_model.dart';
export 'teste3num_model.dart';

class Teste3numWidget extends StatefulWidget {
  const Teste3numWidget({super.key});

  @override
  State<Teste3numWidget> createState() => _Teste3numWidgetState();
}

class _Teste3numWidgetState extends State<Teste3numWidget> {
  late Teste3numModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Teste3numModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'teste3num'});
            ...
            Stack(
              children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'TESTE3NUM_keyboard_backspace_sharp_ICN_O');
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TESTE3NUM_PAGE_menu_rounded_ICN_ON_TAP');
                ...
                Opacity(
                  opacity: 0.7,
                  child: Align(
                    alignment: AlignmentDirectional(1.1, -0.67),
                    child: Padding(
                      padding:
